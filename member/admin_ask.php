...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <section>
    <div id="admin_box">
      <h3 id="member_title">관리자 모드 > 요청 게시판 관리</h3>
      <ul id="board_list">
        <li class="title">
        ...
        <form class="" action="admin_ask_delete.php" method="post">
          <?php
            if (isset($_GET["page"])) {
              $page = $_GET["page"];
            }else {
            ...
            $sql = "select * from ask order by num desc";
          ...
          <ul id="page_num">
            ...
            if ($total_page>=2 && $page >=2) {
              $new_page = $page -1;
              echo "<li><a href='admin_ask.php?page=$new_page'>◀ 이전</a></li>";
            }else {
              echo "<li>&nbsp;</li>";
            }
            for ($i=1; $i <=$total_page ; $i++) {
              if ($page == $i) {
                ...
                echo "<li><a href='admin_ask.php?page=$i'> $i </a></li>";
              }
            }
            if ($total_page>=2 && $page != $total_page) {
              $new_page = $page+1;
              echo "<li><a href='admin_ask.php?page=$new_page'>다음 ▶</a></li>";
            }else {
              echo "<li>&nbsp;</li>";
            }
             ?>
